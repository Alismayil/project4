...
// navbar accordion
const shopRespHomeLiSubMenu1 = document.querySelector('.resp-li-shop-submenu-1')
const shopRespHomeLiSubMenu2 = document.querySelector('.resp-li-shop-submenu-2')
const shopRespHomeLiSubMenu3 = document.querySelector('.resp-li-shop-submenu-3')
// navbar accordion

const blogRespHomeLiSubMenu1 = document.querySelector('.resp-li-blog-submenu-1')
...
function getProduct() {
  axios.get('http://localhost:5000/Pronia').then(x => {
